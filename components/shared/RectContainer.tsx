...
const RectContainer = ({
  ...
  return (
    <div className="flex flex-row justify-between items-start p-2 sm:p-4  bg-white w-full rounded-xl sm:rounded-2xl gap-[0.50rem] drop-shadow-sm sm:drop-shadow-md z-10 sm:max-w-[42rem] cursor-pointer max-h-40 sm:max-h-60">
      ...
      >
        <span className="text-black font-medium sm:font-semibold sm:text-2xl text-[1rem]">
          {id}-{name}
        </span>
